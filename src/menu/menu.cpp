...
void menu::mixBrushImage(){
	...
	unsigned char * pixA = brushImg.getPixels().getData();
	unsigned char * pixB = brushImgInner.getPixels().getData();
	unsigned char * pixC = brushImgMix.getPixels().getData();
...
void menu::setup(){
    ...
    camImg.load("menu/cam.png");
    infoImg.load("menu/info.png");
    lightningImg.load("menu/lightning.png");
    arrowImg.load("menu/menu.png");
    trashImg.load("menu/trash.png");
    brushImg.load("menu/brushA.png");
    brushImgInner.load("menu/brushB.png");
